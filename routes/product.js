...
router.post("/create/:id", verification.authenticate, verification.authorize, productController.create)
router.put("/update/:id", verification.authenticate,  verification.authorize, productController.update)
router.delete("/delete/:id", verification.authenticate,  verification.authorize, productController.delete)
